...
namespace LinearAlgebra
  {
    ...
    { 
      ...
      double c22 = (m1.row[Y][X] * m2.row[X][Y]) + (m1.row[Y][Y] * m2.row[Y][Y]) + (m1.row[Y][Z] * m2.row[Z][Y]) + (m1.row[Y][W] * m2.row[W][X]);
      double c23 = (m1.row[Y][X] * m2.row[X][Z]) + (m1.row[Y][Y] * m2.row[Y][Z]) + (m1.row[Y][Z] * m2.row[Z][Z]) + (m1.row[Y][W] * m2.row[W][X]);
      ...
      double c32 = (m1.row[Z][X] * m2.row[X][Y]) + (m1.row[Z][Y] * m2.row[Y][Y]) + (m1.row[Z][Z] * m2.row[Z][Y]) + (m1.row[Z][W] * m2.row[W][X]);
      double c33 = (m1.row[Z][X] * m2.row[X][Z]) + (m1.row[Z][Y] * m2.row[Y][Z]) + (m1.row[Z][Z] * m2.row[Z][Z]) + (m1.row[Z][W] * m2.row[W][X]);
      ...
      double c42 = (m1.row[W][X] * m2.row[X][Y]) + (m1.row[W][Y] * m2.row[Y][Y]) + (m1.row[W][Z] * m2.row[Z][Y]) + (m1.row[W][W] * m2.row[W][X]);
      double c43 = (m1.row[W][X] * m2.row[X][Z]) + (m1.row[W][Y] * m2.row[Y][Z]) + (m1.row[W][Z] * m2.row[Z][Z]) + (m1.row[W][W] * m2.row[W][X]);
